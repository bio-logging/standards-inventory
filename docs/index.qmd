---
title: "Bio-Logging Data Standards Initiatives Inventory"
format: 
  html:
    page-layout: full
...
/* targets the quarto grid directly */
...
DT::datatable(table_data,
              ...
              caption = htmltools::tags$caption(
                ...
                'This inventory compiles information about community initiatives are working towards data standardization and interoperability in bio-logging science and practice. It is managed by the Data Standardization Working Group of the International Bio-Logging Society (https://bio-logging.net/wg/data-standardisation).'),
              rownames = FALSE)
```
